...
shift_I_T = -1*mV
F = 96485.3329*coulomb/mole  # Faraday constant
R = 8.3144598*joule/mole/kelvin  # gas constant
gamma = F/(R*T)
...
plt.plot((mon.t - cut_off)/ms, voltages[0]/mV, color='gray')
plt.plot((mon.t - cut_off)/ms, voltages[1]/mV, color='black')
plt.xlim(0, 400)
plt.ylim(-80, 40)
plt.xticks([])
plt.title('A1: Uniform T-current density')
plt.ylabel('Voltage (mV)')
plt.gca().spines['right'].set_visible(False)
plt.gca().spines['top'].set_visible(False)
plt.gca().spines['bottom'].set_visible(False)

plt.subplot(2, 2, 3)  # A2
...
plt.xlim(0, 400)
plt.ylim(-80, 40)
plt.title('A2: High T-current density in dendrites')
plt.xlabel('Time (ms)')
plt.ylabel('Voltage (mV)')
plt.gca().spines['right'].set_visible(False)
plt.gca().spines['top'].set_visible(False)
...
plt.plot(currents/pA, maxima_somatic/mV, 'o-', color='black', label='Somatic only')
plt.plot(currents/pA, maxima_somatic_dendritic/mV, 's-', color='black', label='Somatic & dendritic')
plt.ylabel('Peak LTS (mV)')
